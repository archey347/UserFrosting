 ...
 * @author Amos Folz
 */
interface PrimaryIdentityProviderInterface
{
    /**
     * Attempt to authenticate a user using a standard username/password combination (returns a RawUser object if successful)
     *
    ...
    /**
     * logout the user with the external site (if required)
     */
